...
{
    int i, j, k;
    int n1 = m - l + 1; // first subarray is arr[1..m]
...
int main()
{
    ...
    if (file.is_open()) {
        ...
        while (getline(file, line)) {
            ...
            cout<<"Merge Does not have moves!!!"<<endl;
            cout<<"--------------------------------------------------------------------------------------------\n";
        ...
        cout<<"Mohamed Yasser 20226095"<<endl;
        cout<<"Mohamed Khaled 20225056"<<endl;
        cout<<"Mazen Wael  20226084"<<endl;
        cout<<"Thank You!";
